...
options.register ('ActiveDetId',
                  ...
                  VarParsing.VarParsing.varType.bool,          # string, int, or float
                  "Active detid?")
options.register ('APVGainNoiseCorrection',
                  False,
                  VarParsing.VarParsing.multiplicity.singleton, # singleton or list
                  VarParsing.VarParsing.varType.bool,          # string, int, or float
...
if options.LatencyMon == True:
    ...
    #APVGainNoiseCorrection
    process.CondDataMonitoring.SiStripNoisesDQM_PSet.GainRenormalisation = options.APVGainNoiseCorrection
    ...
    process.CondDataMonitoring.SiStripNoisesDQM_PSet.CondObj_fillId        = 'onlyProfile' #onlyCumul'      # Use 'ProfileAndCumul' if you want to have single module histograms
